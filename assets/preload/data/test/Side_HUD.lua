...
function onUpdate(elapsed)
    ...
    setTextString('sick', 'Naisi!!: ' .. getProperty('sicks'))
    setTextString('good', 'Proprai!: ' .. getProperty('goods'))
    setTextString('bad', 'Bruh ' .. getProperty('bads'))
    setTextString('shit', 'Que Pro: ' .. getProperty('shits'))
