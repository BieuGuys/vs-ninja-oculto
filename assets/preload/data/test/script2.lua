...
doTweenY('opponentmove', 'dogao', 100 - 400*math.sin((currentBeat+12*12)*math.pi), 2)
doTweenX('3D BG', '3D BG.scale', 0 - 50*math.sin((currentBeat+1*0.1)*math.pi), 6)
doTweenY('3D BG', '3D BG.scale', 0 - 31*math.sin((currentBeat+1*1)*math.pi), 6)
